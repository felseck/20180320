...
selectBusinessTypes:function(this_){
	...
	return (
		...
		<BootstrapTable data={users}   striped hover  options={options} version='4' selectRow={this.selectRowProp } pagination>
		
		<TableHeaderColumn isKey dataField='id' dataFormat={this.priceFormatter} hiddenOnInsert>ID</TableHeaderColumn>
